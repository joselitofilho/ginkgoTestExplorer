...
export class CachingOutliner {
    ...
    constructor(private context: vscode.ExtensionContext, private outliner: outliner.GinkgoOutliner) {
        this.cacheTTL = getConfiguration().get('cacheTTL', constants.defaultCacheTTL);
